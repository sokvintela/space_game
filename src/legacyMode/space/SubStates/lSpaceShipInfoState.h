...
class LGameShipInfoState : public ISubState
{
	URHO3D_OBJECT(LGameShipInfoState, ISubState);
public:
	...
	LGameShipInfoState(Urho3D::Context * context, UIElement * uiSubState);
	virtual ~LGameShipInfoState() = default;
